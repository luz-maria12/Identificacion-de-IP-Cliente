...
axios.get("https://itp-scr-lmcg-01.000webhostapp.com/php-geoip-api/index.php")
.then(function (response) {
  // manejar respuesta exitosa
  console.log(response.data.zona_horaria);
...
// y llama a la funcion solicitudAPI que tiene la rutina 
